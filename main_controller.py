...
if __name__ == "__main__":
    ...
    control_rate = 30  # Frequency for main control loop
    ...
    breathe_vec = np.array([1, 0, 0])  # named as r in the paper
    ...
    period = 4  # Time in seconds for a breathe
    freq = 1 / period  # Named as beta in the paper
    amplitude = 80  # Tune this. It changes wrt. control rate
    ...
    tick = time.time()
    while not rospy.is_shutdown() and time.time() - breathe_controller.breathe_count < 2:
