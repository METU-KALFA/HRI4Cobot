"""
This code is taken from the "ur_rtde" Python package developed by The University of Southern Denmark.
Package: ur_rtde
Documentation: https://sdurobotics.gitlab.io/ur_rtde/index.html
Source code: https://gitlab.com/sdurobotics/ur_rtde
Maintained by: The University of Southern Denmark (https://www.sdu.dk/en/forskning/sdurobotics)
"""
