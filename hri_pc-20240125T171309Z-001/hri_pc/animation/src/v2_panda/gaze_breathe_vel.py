...
if __name__=="__main__":
    ...
    roti = np.dot(roti.as_matrix(), [0.5,0.5,0])  # Breathe dir in ee frame
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            rot = np.hstack((rot, np.array([[transformation.transform.translation.x,
                                    ...
                                    1.0]]).T))
            # gaze_point_pose = tf_buffer.lookup_transform("base_link", "human_wrist/base_link", rospy.Time())
