...
if __name__=="__main__":
    ...
    while not rospy.is_shutdown():
        ...
        while rospy.get_time() - start < 200:
            ...
            jac3x3 = jacobian[:3,:3]
            pinvjac3x3 = np.linalg.pinv(jac3x3)
            ...
            print("InverseThenSplit",pinv_jacobian[:3])
            print("SplitThenInverse", pinvjac3x3)
            print(np.all(pinvjac3x3 == pinv_jacobian[:3,:3]))
